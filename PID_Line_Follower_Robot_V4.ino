...
// IR Sensors
int sensor1 = 16;      // Left most sensor
int sensor2 = 17;
int sensor3 = 18;
int sensor4 = 19;
int sensor5 = 21;   // Right most sensor
     
// Initial Values of Sensors
int sensor[5] = {0, 0, 0, 0, 0};

// Motor Variables              
int motorInput1 = 25;      //Motor Phải
int motorInput2 = 26;
int motorInput3 = 27;      //Motor Trái
int motorInput4 = 14;                 
...
//con rắn-tăng kd
double T = 12; // chuẩn
double T_1 = 8;  // giảm lắc góc vuông
